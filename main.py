...
class personaje(object):
    ...
    def __init__(self, x, y, fuente, limite):
        ...
        self.quieto = pygame.image.load("img/"+fuente+"moni0a.png")
...
while repetir:
    ...
    heroe = personaje(100, ventana_y - 150, "heroe", ventana_x)
    gato = personaje(1200, ventana_y - 100, "villano", ventana_x)
